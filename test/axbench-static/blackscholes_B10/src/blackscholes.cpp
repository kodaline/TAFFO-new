...
fptype __attribute((annotate("scalar(range('_MIN_STRIKE_RANGE' , '_MAX_STRIKE_RANGE') error(1e-8))"))) *strike; // range(0.33,0.92)
fptype __attribute((annotate("scalar(range('_MIN_RATE_RANGE' , '_MAX_RATE_RANGE') error(0))"))) *rate; //range(0.0275,0.1)
fptype __attribute((annotate("scalar(range('_MIN_VOLATILITY_RANGE' , '_MAX_VOLATILITY_RANGE') error(1e-8))"))) *volatility; //range(0.1,0.65)/////
fptype __attribute((annotate("scalar(range('_MIN_OTIME_RANGE' , '_MAX_OTIME_RANGE') error(0))"))) *otime; // range(0.05,1)
int numError = 0;
