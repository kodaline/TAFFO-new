...
vc::version_ptr_t dynamicCompile() {                                             
  ...
  const vc::opt_list_t opt_list = {
    ...
    vc::make_option("-D_MIN_ANNOTATION_RANGE_N=1"),
    vc::make_option("-D_MAX_ANNOTATION_RANGE_N=2048"),
    vc::make_option("-D_MIN_ANNOTATION_COMPLEX_RANGE=-100"),
    vc::make_option("-D_MAX_ANNOTATION_COMPLEX_RANGE=100"),
  };
