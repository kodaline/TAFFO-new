...
float  __attribute((annotate("scalar(range('_L1_VAL','_L1_VAL') error(1e-8))"))) l1 = _L1_VAL;
float  __attribute((annotate("scalar(range('_L2_VAL', '_L2_VAL') error(1e-8))"))) l2 = _L2_VAL;
...
*/
	float __attribute((annotate("scalar(range('_MIN_SQTMP_RANGE', '_MAX_SQTMP_RANGE') final)"))) sqtmp = (x * x + y * y);
