...
{                                                                              \
              ...
              if (sub1 >= 0.0f)                                                \
              {                                                                \
                float __attribute((annotate("scalar(range('_MIN_ADJ_RANGE', '_MAX_ADJ_RANGE') final)"))) adj1 = sub1; \
              ...
              if (sub2 >= 0.0f)                                                \
              {                                                                \
                float __attribute((annotate("scalar(range('_MIN_ADJ_RANGE', '_MAX_ADJ_RANGE') final)"))) adj2 = sub2; \
